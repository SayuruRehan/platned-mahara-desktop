...
VALUES
    ...
    ('PGE_READ_ACCESS_CONTROL', 'READ USER Details functionality', 'User Admin', 'False', 'False', 'False', 'False', 'PLATNEDPASS', GETDATE(), null, null),
    ('PGE_READ_ACCESS_CONTROL', 'READ USER Details functionality', 'User', 'False', 'False', 'False', 'False', 'PLATNEDPASS', GETDATE(), null, null),
	('BTN_EDIT_ACCESS_CONTROL', 'EDIT USER Details functionality', 'Super Admin', 'True', 'True', 'True', 'True', 'PLATNEDPASS', GETDATE(), null, null),
    ('BTN_EDIT_ACCESS_CONTROL', 'EDIT USER Details functionality', 'User Admin', 'False', 'False', 'False', 'False', 'PLATNEDPASS', GETDATE(), null, null),
    ('BTN_EDIT_ACCESS_CONTROL', 'EDIT USER Details functionality', 'User', 'False', 'False', 'False', 'False', 'PLATNEDPASS', GETDATE(), null, null),
	('BTN_DELETE_ACCESS_CONTROL', 'DELETE USER functionality', 'Super Admin', 'True', 'True', 'True', 'True', 'PLATNEDPASS', GETDATE(), null, null),
    ('BTN_DELETE_ACCESS_CONTROL', 'DELETE USER functionality', 'User Admin', 'False', 'False', 'False', 'False', 'PLATNEDPASS', GETDATE(), null, null),
    ('BTN_DELETE_ACCESS_CONTROL', 'DELETE USER functionality', 'User', 'False', 'False', 'False', 'False', 'PLATNEDPASS', GETDATE(), null, null);