...
GO
/****** Object:  Table [dbo].[PASS_USER_ROLE_ACCESS_TAB]    Script Date: 12/6/2024 3:42:12 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[PASS_USER_ROLE_ACCESS_TAB](
	[APP_FUNCTION] [varchar](200) NOT NULL,
	...
	[MODIFIED_BY] [varchar](50) NULL,
	[MODIFIED_DATE] [datetime] NULL,
 CONSTRAINT [PK_PASS_USER_ROLE_ACCESS_TAB] PRIMARY KEY CLUSTERED 
(
	[APP_FUNCTION] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
